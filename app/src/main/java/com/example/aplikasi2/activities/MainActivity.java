...
import com.example.aplikasi2.model.User;
import com.example.aplikasi2.response.ResponLogin;
import com.example.aplikasi2.rest.ApiClient;
import com.example.aplikasi2.rest.ApiInterface;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btn_Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (username.equals("riana") && password.equals("123456")) {
